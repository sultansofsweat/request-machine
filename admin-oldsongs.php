...
<html lang="en">
  <head>
    ...
    <title><?php echo $name; ?> Music Request System: Dumped Songs</title>
  ...
  <body>
	<h1 style="text-align:center; text-decoration:underline;"><?php echo $name; ?> Music Request System: The Song Dumpster</h1>
