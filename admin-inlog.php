...
<html lang="en">
  <head>
    ...
    <title><?php echo $name; ?> Music Request System: Login Log</title>
  ...
  <body>
	<h1 style="text-align:center; text-decoration:underline;"><?php echo $name; ?> Music Request System: System Login Attempts</h1>
