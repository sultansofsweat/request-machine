...
<html lang="en">
  <head>
    ...
    <title><?php echo $name; ?> Request Machine: Error Log</title>
  ...
  <body>
	<h1 style="text-align:center; text-decoration:underline;"><?php echo $name; ?> Request Machine: Error Messages</h1>
