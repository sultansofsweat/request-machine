...
<html lang="en">
  <head>
    ...
    <title><?php echo $name; ?> Music Request System: Version History</title>
  ...
  <body>
	<h1 style="text-align:center; text-decoration:underline;"><?php echo $name; ?> Music Request System: Version History</h1>
