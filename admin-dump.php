...
<html lang="en">
  <head>
    ...
    <title><?php echo $name; ?> Request Machine: Settings Dump</title>
  ...
  <body>
	<h1 style="text-align:center; text-decoration:underline;"><?php echo $name; ?> Request Machine: List Of All Settings</h1>
